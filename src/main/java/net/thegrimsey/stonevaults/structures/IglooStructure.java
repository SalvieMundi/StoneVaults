...
//
//public class IglooStructure extends StructureFeature<DefaultFeatureConfig> {
//    public static Identifier START_POOL = new Identifier(Stonevaults.MODID, "startpool_igloo");
//
//    public IglooStructure(Codec<DefaultFeatureConfig> codec) {
//        super(codec);
//    }
//
//    @Override
